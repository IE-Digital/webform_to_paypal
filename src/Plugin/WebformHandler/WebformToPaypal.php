...
namespace Drupal\webform_to_paypal\Plugin\WebformHandler;
...
/**
 * Webform to paypal handler.
 *
 * @WebformHandler(
 *   id = "webform_to_paypal_handler",
 *   label = @Translation("Webform To Paypal"),
 *   category = @Translation("Example"),
 *   description = @Translation("Intergate."),
 *   cardinality = \Drupal\webform\Plugin\WebformHandlerInterface::CARDINALITY_SINGLE,
 *   results = \Drupal\webform\Plugin\WebformHandlerInterface::RESULTS_IGNORED,
 *   submission = \Drupal\webform\Plugin\WebformHandlerInterface::SUBMISSION_REQUIRED,
 * )
 */
class WebformToPaypal extends WebformHandlerBase {
